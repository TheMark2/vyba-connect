        ...
        `}>
          ...
          <div className={`space-x-3 ${isMobile ? "w-full flex justify-center" : ""}`}>
            <Button variant="secondary" className="bg-white hover:bg-[#F5F1EB]">
              Buscar con IA
              <Sparkles className="h-4 w-4 ml-1 stroke-3" />
            </Button>
            <Button variant="secondary" className="bg-white hover:bg-[#F5F1EB]">
              Filtros
              <Blend className="h-4 w-4 ml-1 stroke-3" />
            </Button>
          </div>
        </div>
        ...
        <div className={`
          ${isSmallMobile
            ...
            : isMobile
              ...
              : "grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 3xl:grid-cols-5 gap-8"
          }
        `}>
          {artists.map(artist => (
            <ArtistProfileCard 
