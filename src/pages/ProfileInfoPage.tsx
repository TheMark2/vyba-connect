  ...
  return (
    <PageTransition>
      ...
      <div className="bg-vyba-cream dark:bg-vyba-dark-bg min-h-[90vh] px-6 py-16 md:px-10 lg:px-14 xl:px-16">
        <Card className="border-none shadow-none dark:bg-vyba-dark-bg dark:border-vyba-dark-secondary rounded-3xl overflow-hidden max-w-2xl mx-auto px-6 md:px-12 py-16">
