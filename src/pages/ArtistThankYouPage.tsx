...
const ArtistThankYouPage = () => {
  ...
  return (
    <PageTransition>
      <Navbar />
      <div className="bg-vyba-cream dark:bg-vyba-dark-bg flex items-center justify-center min-h-[90vh] px-4 md:px-10 lg:px-14 xl:px-16">
        <Card className="border-none shadow-none bg-secondary dark:bg-vyba-dark-bg dark:border-vyba-dark-secondary rounded-3xl overflow-hidden w-full py-8 md:py-16 mx-auto">
          <motion.div 
            className={`max-w-3xl mx-auto ${isMobile ? 'px-4' : 'px-6'} flex flex-col items-center`} 
          ...
          >
            <motion.h1 
              ...
              className={`${isMobile ? 'text-4xl' : 'text-6xl'} font-black mb-4 text-center dark:text-white`}
            >
              Gracias por formar parte de VYBA
            </motion.h1>
            <motion.h2 
              variants={itemVariants} 
              className={`${isMobile ? 'text-2xl' : 'text-4xl'} mb-8 text-center dark:text-gray-300`}
            >
            ...
            <motion.div 
              variants={itemVariants} 
              className="w-full bg-white dark:bg-vyba-dark-secondary rounded-[40px] p-4 md:p-6 mb-8 md:mb-12 relative overflow-hidden" 
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-4">
                  <div className="bg-gray-50 content-center dark:bg-vyba-dark-secondary/80 p-3 md:p-6 rounded-2xl transition-all duration-300">
                    <div className="flex gap-4 md:gap-6 items-center justify-center">
                      ...
                      <h3 className={`${isMobile ? 'text-3xl' : 'text-5xl'} font-black text-center text-black dark:text-white`}>
                        {artistInfo.artistName}
                      </h3>
                    </div>
                  </div>
                  <div className="bg-gray-50 dark:bg-vyba-dark-secondary/80 p-3 md:p-4 rounded-2xl transition-all duration-300">
                  ...
                  <div className="mt-6 md:mt-8">
                    <span className="px-4 md:px-6 py-2 md:py-3 bg-gray-50 dark:bg-vyba-dark-secondary/80 rounded-full text-sm font-medium">
                      {artistInfo.artistType || "DJ"}
                    </span>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="bg-gray-50 dark:bg-vyba-dark-secondary/80 p-4 md:p-6 rounded-2xl transition-all duration-300">
                    <h4 className="text-lg md:text-xl font-bold mb-2 text-black dark:text-white">
                      Agradecimiento
                    </h4>
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center w-full gap-4 items-center">
              ...
              <Button 
                ...
                className={`w-auto order-1 ${isMobile ? 'w-full sm:w-auto' : ''}`}
              >
                Finalizar
              </Button>
            </motion.div>
            
            <motion.p variants={itemVariants} className="mt-6 md:mt-10 text-sm text-gray-600 dark:text-gray-400">
