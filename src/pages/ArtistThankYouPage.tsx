      ...
      <div className="bg-vyba-cream dark:bg-vyba-dark-bg flex items-center justify-center min-h-[90vh] px-4 sm:px-6 md:px-10 lg:px-14 xl:px-16">
        <Card className="border-none shadow-none bg-secondary dark:bg-vyba-dark-bg dark:border-vyba-dark-secondary rounded-3xl overflow-hidden w-full py-8 sm:py-16 mx-auto">
          <motion.div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-12 flex flex-col items-center" variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.h2 variants={itemVariants} className="text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-8 text-center dark:text-gray-300">
              Artista #{artistNumber}
            </motion.h2>
            
            <motion.div variants={itemVariants} className="w-full bg-white dark:bg-vyba-dark-secondary rounded-[20px] sm:rounded-[40px] p-4 sm:p-6 mb-8 sm:mb-12 relative overflow-hidden" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} onMouseMove={handleMouseMove} ref={el => setElementRef(el)}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4 mt-4 md:mt-0">
                  ...
                  <div className="flex justify-center items-center p-4 sm:p-6">
                    <Button onClick={handleDownloadDiploma} className="flex items-center gap-2 bg-gray-50 hover:bg-gray-100 text-black dark:bg-vyba-dark-secondary/80 dark:hover:bg-vyba-dark-secondary/60 dark:text-white w-full sm:w-auto">
            ...
            <motion.p variants={itemVariants} className="mt-6 sm:mt-10 text-sm text-gray-600 dark:text-gray-400">
