...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col p-0 m-0">
      {/* Contenedor de la sección con animación de scroll */}
      <div 
        ref={scrollRef}
        className="h-[300vh] relative"
      >
        {/* Navbar fuera del sticky para que siempre esté en la parte superior */}
        <div className="absolute top-0 left-0 right-0 z-50">
          <Navbar className="mx-auto" />
        </div>
        
        {/* Contenedor sticky que incluye todo excepto la navbar */}
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          <div className="relative w-full h-screen overflow-hidden">
            ...
            <div className="relative z-20 container mx-auto px-8 md:px-16 lg:px-24 xl:px-32 2xl:max-w-[1800px] h-full flex flex-col justify-center">
              {/* Espacio para compensar la altura de la navbar */}
