            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-12">
                <div className="order-1 md:order-1">
                  <h2 className="text-5xl font-black mb-4 leading-snug">Explora y elige el artista perfecto para tu evento</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-12">
                ...
                <div className="order-1 md:order-2">
                  <h2 className="text-5xl font-black mb-4 leading-snug">Contacta con el artista de una forma fácil y rápida</h2>
                  <p className="text-gray-600">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-12">
                <div className="order-1 md:order-1">
                  <h2 className="text-5xl font-black mb-4 leading-snug">Confirma la reserva y disfruta de un show inolvidable</h2>
                  <p className="text-gray-600">
