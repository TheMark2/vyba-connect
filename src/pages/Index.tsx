            ...
            <div className="relative w-full h-screen overflow-hidden">
              <motion.div className="absolute inset-0 px-6 md:px-10 lg:px-14 xl:px-16 pt-8 pb-32">
                <motion.div className="relative w-full h-full rounded-[2vw] overflow-hidden">
                  ...
                  <motion.div className="absolute inset-0 flex flex-col justify-center text-white px-6 md:px-12 lg:px-16" style={{
                  y: textTranslateY
                }}>
                    <div className="max-w-3xl mx-0">
                      <motion.h1 className="text-4xl md:text-5xl lg:text-7xl font-black mb-8 text-white leading-tight" style={{
                      opacity: 1,
                      ...
                      <motion.div className="flex w-full relative" style={{
                      scale: searchScale
                    }}>
                        <div className="relative w-full flex items-center">
                          <Input type="text" placeholder={String(searchPlaceholder)} value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pr-14 bg-white/95 text-black placeholder:text-gray-500 h-14 text-lg rounded-full border-0" />
