                ...
                <div className="bg-secondary dark:bg-vyba-dark-secondary/70 rounded-3xl overflow-hidden">
                  <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1" className="border-b-0">
                      <AccordionTrigger className="px-8 py-6 text-xl font-bold hover:no-underline">
                        ¿Cómo puedo reservar una fecha?
                      </AccordionTrigger>
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          Puedes reservar una fecha con {artist.name} haciendo clic en el botón "Contactar" que aparece 
                          en la parte derecha de la pantalla. Completarás un formulario con los detalles de tu evento 
                          y te pondremos en contacto lo antes posible para confirmar disponibilidad.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-2" className="border-b-0">
                      <AccordionTrigger className="px-8 py-6 text-xl font-bold hover:no-underline">
                        ¿Qué incluye el servicio de DJ?
                      </AccordionTrigger>
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          El servicio incluye equipamiento profesional de sonido, una amplia selección musical adaptada 
                          a tu evento, y {artist.timeRequirements?.[1] || "tiempo de montaje"}. Consulta la sección de 
                          "Logística y equipamiento" para más detalles específicos sobre el equipo incluido.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-3" className="border-b-0">
                      ...
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          ¡Por supuesto! Antes del evento, podrás compartir una lista de tus canciones favoritas o 
                          imprescindibles. {artist.name} se asegurará de incluirlas en el set durante la celebración, 
                          siempre manteniendo un flujo musical adecuado para el ambiente.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-4" className="border-b-0">
                      ...
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          Las cancelaciones realizadas con más de 30 días de antelación reciben un reembolso completo 
                          de la señal. Para cancelaciones entre 15-30 días antes del evento, se reembolsa el 50%. 
                          Las cancelaciones con menos de 15 días no son reembolsables, pero se puede reprogramar 
                          la fecha según disponibilidad.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-5" className="border-b-0">
                      ...
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          Se requiere un 25% del precio total como señal para reservar la fecha. El 75% restante 
                          puede abonarse hasta 7 días antes del evento. Aceptamos transferencias bancarias y 
                          métodos de pago online seguros. Todos los detalles de pago se proporcionarán tras 
                          la confirmación de disponibilidad.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                    ...
                    <AccordionItem value="item-6" className="border-b-0">
                      <AccordionTrigger className="px-8 py-6 text-xl font-bold hover:no-underline">
                        ¿Se desplaza a otras ciudades?
                      </AccordionTrigger>
                      <AccordionContent className="px-8 pb-6 pt-0">
                        <p className="text-base">
                          Sí, {artist.name} está disponible para desplazarse a eventos en distintas ubicaciones. 
                          Los gastos de desplazamiento y posible alojamiento se calcularán según la distancia y 
                          se añadirán al presupuesto final. Consulta los detalles específicos al hacer tu reserva.
                        </p>
                      </AccordionContent>
                    </AccordionItem>
                  </Accordion>
