              ...
              <div className="mt-8 mb-16">
                ...
                <div className="space-y-4">
                  {artist.musicPreviews?.map((preview, index) => (
                    <div 
                      key={index} 
                      className="group grid grid-cols-[auto_1fr_auto] items-center gap-4 p-2 bg-secondary dark:bg-vyba-dark-secondary/70 rounded-2xl hover:bg-opacity-80 transition-colors duration-200 cursor-pointer hover:bg-secondary/90 dark:hover:bg-vyba-dark-secondary/90 relative"
                    >
                      <div className="relative w-14 h-14 flex-shrink-0 rounded-md overflow-hidden">
                        {/* Blurred background image */}
                        <div 
                          className="absolute -inset-4 bg-cover bg-center blur-xl opacity-40" 
                          style={{ 
