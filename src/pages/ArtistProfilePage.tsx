  ...
  return <>
      ...
      <div className="px-6 md:px-10 lg:px-14 xl:px-16">
        <div className="relative w-full h-[calc(95vh)] md:h-[calc(100vh-10rem)] overflow-hidden rounded-[25px] lg:rounded-[35px]">
          ...
          {isMobile ? <div className="absolute bottom-12 left-5 right-0 flex flex-col items-start">
            ...
            </div> : <div className="absolute bottom-12 left-5 md:left-10 lg:left-14 flex items-center">
          ...
          <div className="min-h-[400px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="text-4xl">
                <h3 className="text-base  mb-3">Servicios</h3>
                <p>
