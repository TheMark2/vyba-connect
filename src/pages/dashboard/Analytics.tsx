...
import { Calendar, Download, Users, Eye, MessageSquare, Share2 } from "lucide-react";
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Visitó tu perfil hace {i} hora{i > 1 ? 's' : ''}
                    </div>
                  </div>
                </div>
              ))}
        ...
        <Card>
          <CardHeader>
            <CardTitle>Mensajes más recientes</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {[1, 2, 3].map((i) => (
                <div key={i} className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="font-medium">Usuario {i}</div>
                    <div className="text-sm text-muted-foreground">
                      Envió un mensaje hace {i} hora{i > 1 ? 's' : ''}
                    </div>
                  </div>
                </div>
              ))}
