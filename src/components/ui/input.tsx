  ...
  ({ className, type, showVerified, error, ...props }, ref) => {
    return (
      <input
        type={type}
        className={cn(
          "flex h-14 w-full rounded-2xl bg-[#F7F7F7] px-6 py-3 text-base md:text-sm ring-offset-background placeholder:text-gray-500 placeholder:font-regular disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-300 ease-in-out text-black font-medium",
