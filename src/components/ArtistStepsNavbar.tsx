        ...
        <div className="hidden md:flex items-center justify-center">
          {steps.map((step, index) => <React.Fragment key={step.number}>
              <div className="flex items-center">
                <div className={cn("w-6 h-6 rounded-sm flex items-center justify-center text-xs font-bold", step.isActive ? "bg-black text-white dark:bg-white dark:text-black" : step.isCompleted ? "bg-gray-400 text-white" : "bg-[#EBEBEB] text-gray-500 dark:bg-gray-700")}>
                  {step.number}
                </div>
