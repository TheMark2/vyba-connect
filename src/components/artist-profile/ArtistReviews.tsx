...
const ArtistReviews = ({
  ...
  return <div className="mt-8 mb-16">
      <div className={`${isMobile ? 'bg-[#F7F7F7] py-8 -mx-6' : ''}`}>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-center mt-8">
            <Button variant={isMobile ? "ghost" : "secondary"} className={isMobile ? "px-12 bg-white border-none" : "px-12"} onClick={handleVerTodas}>
              Ver todas
            </Button>
          </div>
        </div>
      ...
      {isMobile && <SwipeableBottomSheet overflowHeight={0} marginTop={0} open={isBottomSheetOpen} onChange={setIsBottomSheetOpen} fullScreen={true} topShadow={false} shadowTip={false} bodyStyle={{
