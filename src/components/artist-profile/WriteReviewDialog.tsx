...
const WriteReviewDialog = ({
  ...
  const renderLoginContent = () => {
    return <div className="flex flex-col w-full">
      ...
      <h2 className="text-3xl font-black mb-6 animate-fade-up">Inicia sesión o regístrate</h2>
      
      <div className="bg-[#F7F7F7] rounded-2xl p-6 mb-8 text-center dark:bg-vyba-dark-secondary/20 animate-fade-up" style={{ animationDelay: '100ms' }}>
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          <div className="flex flex-col items-center animate-fade-up" style={{ animationDelay: '150ms' }}>
            <Button variant="outline" size="icon" className="w-16 h-16 rounded-full mb-2 bg-white dark:bg-black border-0 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-300" onClick={handleLoginClick}>
          ...
          <div className="flex flex-col items-center animate-fade-up" style={{ animationDelay: '250ms' }}>
            <Button variant="outline" size="icon" className="w-16 h-16 rounded-full mb-2 bg-white dark:bg-black border-0 hover:bg-gray-100 dark:hover:bg-gray-900 transition-all duration-300" onClick={handleLoginClick}>
        ...
        <Button onClick={handleLoginClick} className="px-8 bg-[#D4DDFF] hover:bg-[#C0D0FF] text-black dark:text-white rounded-full transition-all duration-300 animate-fade-up" style={{ animationDelay: '350ms' }}>
          Iniciar sesión
        </Button>
      </div>
    </div>;
  ...
  const renderReviewContent = () => <div className="flex flex-col w-full">
      ...
      <h2 className="text-3xl font-semibold mb-6 animate-fade-up">Escribe una reseña</h2>
      
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4 animate-fade-up" style={{ animationDelay: '100ms' }}>
        {isLoading ? (
          ...
          <div className="bg-[#F7F7F7] rounded-full pl-3 pr-6 py-3 dark:bg-vyba-dark-secondary/20 animate-fade-in-fast">
            <div className="flex items-center gap-5">
        ...
        <div className="flex flex-col items-end gap-2 animate-fade-up" style={{ animationDelay: '200ms' }}>
      ...
      <div className="mb-6 animate-fade-up" style={{ animationDelay: '300ms' }}>
        ...
        <Input id="title" value={title} onChange={e => setTitle(e.target.value)} placeholder="Muy buen servicio" className="transition-all duration-300" />
      </div>
      ...
      <div className="mb-8 animate-fade-up" style={{ animationDelay: '400ms' }}>
        ...
        <Textarea id="comment" value={comment} onChange={e => setComment(e.target.value)} placeholder="Muy buen servicio" className="min-h-32 transition-all duration-300" />
      </div>
      
      <div className="flex items-center mb-8 bg-[#F7F7F7] rounded-xl p-4 relative overflow-hidden transition-all duration-300 hover:bg-[#F0F0F0] dark:bg-vyba-dark-secondary/20 dark:hover:bg-vyba-dark-secondary/30 cursor-pointer animate-fade-up" style={{ animationDelay: '500ms' }} onClick={e => {
      handleRippleEffect(e);
      setAcceptedPolicy(!acceptedPolicy);
    }}>
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-3">
            <Checkbox id="terms" checked={acceptedPolicy} onCheckedChange={checked => setAcceptedPolicy(checked as boolean)} className="h-5 w-5 rounded-sm border-2 border-black dark:border-white data-[state=checked]:border-black dark:data-[state=checked]:border-white transition-all duration-300" />
      ...
      <div className="flex justify-end animate-fade-up" style={{ animationDelay: '600ms' }}>
        <Button onClick={handleSubmit} disabled={!title || !comment || !acceptedPolicy} className="px-8 bg-[#D4DDFF] hover:bg-[#C0D0FF] text-black dark:text-white rounded-full transition-all duration-300">
          Enviar
        </Button>
      </div>
    </div>;
