...
const Navbar = () => {
  return <nav className="bg-vyba-cream backdrop-blur-xl">
      <div className="container mx-auto px-56 md:px-40 lg:px-8 xl:px-2 h-24 flex items-center justify-between">
        <div className="flex items-center space-x-8">
          <h1 className="text-2xl font-bold">VYBA</h1>
          <div className="hidden md:flex items-center space-x-1">
            <Link to="/" className="nav-link">Inicio</Link>
            <Link to="/artistas" className="nav-link bg-secondary">Artistas</Link>
