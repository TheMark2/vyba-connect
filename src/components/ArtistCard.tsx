...
const ArtistCard = ({
  ...
  return (
    <div className="relative">
      {/* Main card container */}
      <div 
        className="flex flex-col items-start bg-[#F5F1EB] p-6 rounded-3xl min-w-[400px] mx-3 cursor-pointer"
        onClick={onClick}
      ...
      >
        ...
        <div className="w-full mt-3">
          {/* Badge de tipo */}
          <Badge variant="outline" className="bg-white text-black mb-5 py-3 px-6 text-sm rounded-full border-0">
            ...
            <div className="flex relative">
              {visibleAvatars.map((avatar, index) => (
                <Avatar 
                  ...
                  style={{
                    zIndex: visibleAvatars.length - index // Asegurando que los avatares de la izquierda estén por encima
                  }}
                >
              ...
              {extraAvatars > 0 && (
                <div 
                  ...
                  style={{
                    zIndex: 0 // El contador siempre estará detrás de los avatares
                  }}
                >
                  +{extraAvatars}
                </div>
